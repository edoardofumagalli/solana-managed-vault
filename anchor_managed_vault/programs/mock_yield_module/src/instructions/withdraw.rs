...
use crate::{
    constants::{
        MOCK_MODULE_AUTHORITY_SEED, MOCK_MODULE_STATE_SEED, MODULE_CALL_AUTHORITY_SEED,
    },
    errors::MockYieldModuleError,
    events::MockModuleWithdrawnEvent,
...
pub struct Withdraw<'info> {
    ...
    #[account(
        mut,
        token::mint = underlying_mint,
        token::authority = mock_module_state.vault,
        token::token_program = token_program,
    )]
